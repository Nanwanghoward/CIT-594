...
public class Recommender {
  ...
  public Recommender(RatingMatrix ratingMatrix) {
    ...
    this.ratingMatrix.calcOverallAverage();
  }
  ...
  public int setCurrentUser(String user) {   
    if(ratingMatrix.getUserSet().contains(user)) {
...
//      System.out.println("user:"+iter+" sim:"+ similarity.getSimilarity(currentUser.getName(), iter, ratingMatrix));
    }
...
//  }
  ...
  public void setEngine(int engine) {
    ...
    if(engine == 1) {
      ...
      prediction = new BaseLinePrediction();
      preference = new DefaultPreference(prediction);
    }
